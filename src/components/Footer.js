            ...
            <div className="container">
                <div className="wrapper">
                    ...
                    <div className="services">
                        ...
                        <div className="service">
                            <a href="#" className="serviceLink">Приложения</a>
                        </div>
                        <div className="service">
                            <a href="#" className="serviceLink">Самописные системы</a>
                        </div>
                        <div className="service">
                            <a href="#" className="serviceLink">Парсинг</a>
                        </div>
                        <div className="service">
                    ...
                    <div className="services">
                        <div className="service">
                            <a href="#" className="serviceLink">Маркетинг</a>
                        </div>
                        <div className="service">
                            <a href="#" className="serviceLink">Контекст</a>
                        </div>
                        <div className="service">
                            <a href="#" className="serviceLink">SMM</a>
                        </div>
                        <div className="service">
                            <a href="#" className="serviceLink">SEO</a>
                        </div>
                        <div className="service">
                            <a href="#" className="serviceLink">Работа с репутацией</a>
                        </div>
                        <div className="service">
                            <a href="#" className="serviceLink">Брендинг</a>
                        </div>
                    </div>
