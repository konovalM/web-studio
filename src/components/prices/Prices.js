            ...
            <Element >
                <div className="wrapperPrices">
                    ...
                    <Element name='#landings'>
                        <PricesComponent title='лендинги визитки' price='1000' content={landing} id={1}
                                         typeOfCase='landings' sliderData={SliderMockData.landings}/>
                    </Element>
                    <Element name='shops'>
                        <PricesComponent title='online магазины' margin='225px' price='2400' content={shops} id={2}
                                         typeOfCase='shops' sliderData={SliderMockData.shops}/>
                    </Element>
                    <Element name='sites'>
                        <PricesComponent title='многостраничные сайты' size={true} margin='225px' price='1600'
